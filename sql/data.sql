...
INSERT INTO `param` VALUES (1,'amount',1,0),(2,'weight',1,2),(3,'length',1,1),(4,'time',1,3),(5,'quality',2,0),(6,'dependency',3,0);
...
UNLOCK TABLES;
DROP TABLE IF EXISTS `param_val`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `param_val` VALUES (1,1,1,NULL,NULL),(2,6,NULL,'bad',NULL),(3,8,99,NULL,7);
...
INSERT INTO `resource_param` VALUES (1,1,2,11,1),(2,1,3,11,0),(5,1,4,11,0),(6,1,5,11,0),(7,4,2,11,1),(8,1,6,11,0);
