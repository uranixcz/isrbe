...
--
-- Table structure for table `quantity_10exp`
--
...
--
-- Dumping data for table `quantity_10exp`
--
...
--
-- Dumping data for table `resource_location`
--
...
--
-- Table structure for table `resource_quantity`
--
...
--
-- Dumping data for table `resource_quantity`
--
...
--
-- Table structure for table `transform_hdr`
--
...
--
-- Dumping data for table `transform_line`
--
...
--
-- Table structure for table `transform_type`
--
...
--
-- Dumping data for table `transform_type`
--

LOCK TABLES `transform_type` WRITE;
/*!40000 ALTER TABLE `transform_type` DISABLE KEYS */;
INSERT INTO `transform_type` VALUES (1,'User order'),(2,'Natural'),(3,'Manufakturing'),(4,'Degeneration');
